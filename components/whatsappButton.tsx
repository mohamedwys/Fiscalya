...
const WhatsappButton: React.FC = () => {
  const handleWhatsappClick = () => {
    window.open('whatsapp://send?phone=+971525866003&text=Hello, I need assistance.', '_blank');
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-green-500 text-white p-3 rounded-full cursor-pointer" 
