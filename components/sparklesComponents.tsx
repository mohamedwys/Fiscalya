    ...
    <div className="h-[20rem] w-full bg-neutral-200 flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div className="w-[40rem] h-40 relative">
        ...
        <SparklesCore
          ...
          particleColor="[#820000]"
        />

        {/* Radial Gradient to prevent sharp edges */}
        <div className="absolute inset-0 w-full h-full bg-neutral-200 [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
      </div>
    </div>
  );
}
