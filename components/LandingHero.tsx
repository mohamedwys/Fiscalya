  ...
  return (
    <div className="text-neutral-200 font-bold py-36 text-center space-y-5">
      <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl space-y-5 font-extrabold text-zinc-500 bg-clip-text bg-zinc-500">
        ...
        <div className="text-transparent  bg-clip-text bg-gradient-to-r from-[#6A82FB] to-[#CB837F] ">
          <TypewriterComponent
            options={{
              strings: [
                "Tax Assistance",
      ...
      <div className="text-sm mt-20 md:text-xl top- font-light text-zinc-500 space-y-5">
