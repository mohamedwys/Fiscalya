        ...
        <footer className='bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>
            ...
            <div className='md:flex md:justify-center md:gap-24 grid grid-cols-2 mx-auto'>
                <div className='px-4 mt-4 mb-2'>
                    <div className=' mt-1'>
                        <h1 className='text-base text-zinc-500 font-black'>NexT-Component.</h1>
                    </div>
                    <div className=' mt-1'>
                        <p className='text-zinc-500-sm '>©Alfath Izha Barikallah</p>
                    </div>
                </div>
                <div className='px-4 mt-4 mb-2'>
                    ...
                    <ul className='list-none text-zinc-500'>
                        <li className='mb-3'>
                            <Link className='hover:text-zinc-500 duration-500  text-sm' href={"/about"}>About</Link>
                        </li>
                        <li className='mb-3'>
