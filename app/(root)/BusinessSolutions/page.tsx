...
const BusinessSolutions = async ({ searchParams }: SearchParamProps) => {
    ...
    <LandingNavbar />
      <section className="container mx-auto py-12">
        <div className="flex flex-col items-center justify-center gap-6">
          <Image src="/assets/icons/business.svg" alt="Call" width={100} height={100} />
          <h2 className="h2-bold text-zinc-500">Together, We'll Take Care of Your Business</h2>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div className="bg-white text-center shadow-md rounded-lg p-6">
